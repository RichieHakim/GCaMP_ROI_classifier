...
dir_save = '/n/data1/hms/neurobio/sabatini/josh/analysis/ROI_net_training/20220510_testingSimCLRscript'
...
path_script = '/n/data1/hms/neurobio/sabatini/josh/github_repos/GCaMP_ROI_classifier/scripts/20220508_simCLR_JZ20220511/train_ROInet_simCLR_20220508.py'
...
# params = [container_helpers.deep_update_dict(params, ['lr'], val) for val in [10**-1.5, 10**-2.5, 10**-3.5,]]
