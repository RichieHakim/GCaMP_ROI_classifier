...
params = [container_helpers.deep_update_dict(params, ['augmentation', 'AddPoissonNoise', 'scaler_bounds'], val) for val in [(1.0*10**3, 1.0*10**3.5), (1.0*10**3.5, 1.0*10**4), (1.0*10**4, 1.0*10**4.5), (1.0*10**3.65, 1.0*10**3.85), (1.0*10**3.25, 1.0*10**4.25), (1.0*10**2.75, 1.0*10**4.75)]]
