...
suffix = 'horizontalStripeScale-alpha_min_max'
...
params_template = {
    'paths': {
        ...
        'fileName_save_model': 'ConvNext_tiny__1_0_best__simCLR',
...
# dir_save = f'/n/data1/hms/neurobio/sabatini/josh/analysis/ROI_net_training/20220630_SimCLR_{suffix}'
dir_save = f'/n/data1/hms/neurobio/sabatini/josh/analysis/ROI_net_training/20220713_SimCLR_{suffix}'
...
path_script = '/n/data1/hms/neurobio/sabatini/josh/github_repos/GCaMP_ROI_classifier/scripts/20220630_simCLR/train_ROInet_simCLR_20220508.py'
eval_script = '/n/data1/hms/neurobio/sabatini/josh/analysis/20220630-setup-eval-sbatch.py'

## make params dicts with grid swept values
params = copy.deepcopy(params_template)
# params = [container_helpers.deep_update_dict(params, ['temperature'], val) for val in [0.03, 0.01]]
# params = [container_helpers.deep_update_dict(params, ['temperature'], val) for val in [0.1, 0.03, 0.01, 0.003, 0.001]]
# params = [container_helpers.deep_update_dict(params, ['lr'], val) for val in [0.00001, 0.0001, 0.001, 0.003, 0.01, 0.03]]
...
# params = [container_helpers.deep_update_dict(params, ['augmentation', 'AddPoissonNoise', 'prob'], val) for val in [0.0, 0.6, 0.7, 0.8]]
# params = [container_helpers.deep_update_dict(params, ['augmentation', 'AddPoissonNoise', 'scaler_bounds'], val) for val in [(3, 3.5), (3.5, 4), (4, 4.5), (3.65, 3.85), (3.25, 4.25), (2.75, 4.75)]]
params = [container_helpers.deep_update_dict(params, ['augmentation', 'Horizontal_stripe_scale', 'alpha_min_max'], val) for val in [(0.75, 1), (0.2, 1)]]
...
shutil.copy2(eval_script, str(Path(dir_save) / Path(eval_script).name));
...
sbatch_config_list = \
[f"""#!/usr/bin/bash
#SBATCH --job-name=simCLR_{suffix}
#SBATCH --output={path}
