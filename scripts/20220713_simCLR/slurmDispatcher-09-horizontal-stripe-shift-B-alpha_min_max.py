...
suffix = 'horizontalStripeShift-alpha_min_max'
...
params = [container_helpers.deep_update_dict(params, ['augmentation', 'Horizontal_stripe_shift', 'alpha_min_max'], val) for val in [(1, 1), (2, 3)]]
