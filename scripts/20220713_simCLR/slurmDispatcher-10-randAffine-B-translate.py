...
params = [container_helpers.deep_update_dict(params, ['augmentation', 'RandomAffine', 'translate'], val) for val in [(0.05, 0.05), (0.1, 0.1), (0.15, 0.15), (0.25, 0.25)]]
