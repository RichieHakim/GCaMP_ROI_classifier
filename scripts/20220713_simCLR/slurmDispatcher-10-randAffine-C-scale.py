...
params = [container_helpers.deep_update_dict(params, ['augmentation', 'RandomAffine', 'scale'], val) for val in [(0.6, 1.5), (0.4, 1.2), (0.8, 1.1), (0.8, 1.4)]]
