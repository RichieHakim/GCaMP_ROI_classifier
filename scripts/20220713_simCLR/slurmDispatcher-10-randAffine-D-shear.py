...
params = [container_helpers.deep_update_dict(params, ['augmentation', 'RandomAffine', 'shear'], val) for val in [(-3, 3, -3, 3), (-5, 5, -5, 5), (-8, 8, -8, 8), (-11, 11, -11, 11)]]
