...
params = [container_helpers.deep_update_dict(params, ['augmentation', 'WarpPoints', 'dx'], val) for val in [(-0.1, 0.1), (-0.3, 0.3), (-0.5, 0.5)]]
params = [container_helpers.deep_update_dict(_, ['augmentation', 'WarpPoints', 'dy'], _['augmentation']['WarpPoints']['dx']) for _ in params]
