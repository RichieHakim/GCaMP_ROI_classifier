...
#     'penalty_orthogonality':0.00,
    ...
    'augmentation': {
        ...
        'AddPoissonNoise': {'scaler_bounds':(1.0*10**2.75, 1.0*10**4.75), 'prob':0.7, 'base':1000, 'scaling':'log'},
        ...
        'RandomAffine': {
            ...
            'scale':(0.8, 1.4), # no scale (1,1), (0.4, 1.5)
            'shear':(-5, 5, -5, 5),
#             'interpolation':torchvision.transforms.InterpolationMode.BILINEAR, 
        ...
        'AddGaussianNoise': {'mean':0, 'std':0.0003, 'prob':0.5},
...
params = [container_helpers.deep_update_dict(params, ['temperature'], val) for val in [0.03, 0.03, 0.03, 0.03, 0.03]]

params_unchanging, params_changing = container_helpers.find_differences_across_dictionaries(params)

# print('params_unchanging',  params_unchanging)
# print('params_changing', params_changing)

# raise ValueError('Non-Error')
