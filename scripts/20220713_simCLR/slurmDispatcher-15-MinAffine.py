...
#     'penalty_orthogonality':0.00,
    ...
    'augmentation': {
        ...
        'AddPoissonNoise': {'scaler_bounds':(1.0*10**3.25, 1.0*10**3.75), 'prob':0.7, 'base':1000, 'scaling':'log'},
        ...
        'RandomAffine': {
            'degrees':(-15,15),
            'translate':(0.02, 0.02), #0, .3, .45 (DEFAULT)
            'scale':(0.9, 1.1), # no scale (1,1), (0.4, 1.5)
            'shear':(-2, 2, -2, 2),
