...
path_selfScript, dir_save_parent, path_script, name_slurm, name_job, dir_data, param_sweep_run_dir = sys.argv
dir_save = str(Path(dir_save_parent) / name_slurm)


# path_selfScript = "/n/data1/hms/neurobio/sabatini/josh/github_repos/GCaMP_ROI_classifier/scripts/eval/dispatcher.py"
# dir_save = "/n/data1/hms/neurobio/sabatini/josh/analysis/gcamp_eval"
# path_script = "/n/data1/hms/neurobio/sabatini/josh/github_repos/GCaMP_ROI_classifier/scripts/eval/eval-params-sweep.py"
# name_slurm = "job_name"
# name_job = "20220512_SimCLR_preHeadDepth"
# dir_data = "/n/data1/hms/neurobio/sabatini/josh/github_repos/GCaMP_ROI_classifier/data/training/mouse2_6__20210409"
# param_sweep_run_dir = "/n/data1/hms/neurobio/sabatini/rich/analysis/ROI_net_training/20220512_SimCLR_preHeadDepth"
...
params_template = {
    "github_loc": dir_github,
    "path_stat": str(Path(dir_data) / 'stat.npy'),
    
    "input_dir": param_sweep_run_dir,    
    "path_labels": ["/n/data1/hms/neurobio/sabatini/josh/github_repos/GCaMP_ROI_classifier/data/training/mouse2_6__20210409/labels_round2_sesh1.npy", "/n/data1/hms/neurobio/sabatini/josh/github_repos/GCaMP_ROI_classifier/data/training/mouse2_6__20210409/labels_round2_sesh2.npy"],
    
    "model_loc": "/n/data1/hms/neurobio/sabatini/josh/github_repos/GCaMP_ROI_classifier/scripts/eval_20220712/model.py",
...
paths_log = [str(Path(dir_save) / f'{name_save}{jobNum}' / f'print_log_%j.log') for jobNum in range(len(params))]
